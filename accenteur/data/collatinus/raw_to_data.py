...
this_dir = os.path.abspath("/Users/frromain/Doc/Langues/Latin/latin-ecclesiastic-accents/accenteur/data/collatinus/")

# Delete the contents of data.js:
this_file = open(this_dir + "/data.txt", "w", encoding="utf-8")
this_file.write("");
this_file.close()
